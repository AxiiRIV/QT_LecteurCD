...
struct qt_meta_stringdata_CLASSSortieSonENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSortieSonENDCLASS = QtMocHelpers::stringData(
    "SortieSon",
    "setVolume",
    "",
    "pVolume",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSortieSonENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SortieSon::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSortieSonENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSortieSonENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSortieSonENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<SortieSon, std::true_type>,
        // method 'setVolume'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<float, std::false_type>,
        // method 'desactiverSon'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'activerSon'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
...
void *SortieSon::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSortieSonENDCLASS.stringdata0))
