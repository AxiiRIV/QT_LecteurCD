...
template <> constexpr inline auto LecteurCD::qt_create_metaobjectdata<qt_meta_tag_ZN9LecteurCDE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'ChangerEtatLecteur'
        QtMocHelpers::SignalData<void(LecteurCD::UnEtat)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
    };
...
void LecteurCD::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LecteurCD::*)(LecteurCD::UnEtat )>(_a, &LecteurCD::ChangerEtatLecteur, 0))
            return;
    }
}
